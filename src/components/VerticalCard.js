            ...
            <div className='flex flex-wrap gap-4 justify-center'>
                {loading ? (
                    ...
                    data.map((product, index) => (
                        <Link key={index} to={"/product/" + product?._id} className='lao-text w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[300px] bg-white rounded-sm shadow' onClick={scrollTop}>
                            ...
                            <div className='p-4 grid gap-3'>
                                ...
                                <div className='flex gap-3'>
                                    <p className='text-yellow-700 font-medium'>{displayINRCurrency(product?.sellingPrice)}</p>
